...
class Magentothem_Installtemplate_Model_Installtemplate extends Mage_Core_Model_Abstract {
    ...
    public function saveTemplateConfig(int $store) {
		...
		Mage::getConfig()->saveConfig('design/package/name', 'flaton', $scope, $store);
        Mage::getConfig()->saveConfig('design/theme/default', 'ma_flaton4', $scope, $store);
        Mage::getConfig()->saveConfig('web/default/cms_home_page', 'flaton_home', $scope, $store);
		Mage::getConfig()->saveConfig('design/theme/default', 'ma_flaton4', 'default', 0);
        Mage::getConfig()->saveConfig('web/default/cms_home_page', 'flaton_home', 'default', 0);
		Mage::getConfig()->saveConfig('web/default/cms_no_route', 'no-route1', $scope, $store);
        Mage::getConfig()->saveConfig('web/default/cms_no_route', 'no-route1', 'default', 0);
    }
